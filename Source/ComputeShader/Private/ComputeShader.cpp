...
void FComputeShader::StartupModule()
{
	...
	FString PluginShaderDir = FPaths::Combine(IPluginManager::Get().FindPlugin(TEXT("VoxelPlugin"))->GetBaseDir(), TEXT("Shaders/ComputeShader/Private"));
...
IMPLEMENT_MODULE(FComputeShader, VoxelPlugin)
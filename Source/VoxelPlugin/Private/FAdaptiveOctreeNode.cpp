...
{
    if (LodOverride) return false;
    return EvaluateMerge(Extent, FVector::DistSquared(DualContourPosition, InCameraPosition), InFOVScale, MergeThresholdSq, Index.Depth, DepthBounds[0], DepthBounds[2]);
}
